...
export const ChartTemplate = props => {
  /*
  We render the dc chart using an effect. We want to pass the chart as a
   prop after the dc call,
  ...
  */
  ...
  React.useEffect(() => {
    const newChart = props.chartFunction(div.current, ndx, props.keys, props.keys2, props.id); // chartfunction takes the ref and does something with it
