...
import BarData from '../Components/Int/bar_charts.json'
import LineData from '../Components/Int/line_chart.json'
import PieData from '../Components/Int/pie_chart.json'
...
const Dashboard = (props) => {
  ...
  return (
    <div {...style}>
      <div>
        {<Chart data={BarData} charInfo={[{ "XValue": "month", 'Yvalue': 'customer', 'Ctype': 'bar', 'Id': 'Bar' }]} />}
      </div>
      <div>
        {<Chart data={LineData} charInfo={[{ "XValue": "year", 'Yvalue': 'customer', 'Ctype': 'line', 'Id': 'Line' }]} />}
      </div>
      <div>
        {<PieChart data={PieData} charInfo={[{ "XValue": "store", 'Yvalue': 'customer', 'Ctype': 'pie', 'Id': 'Pie' }]} />}
      </div>
      <div>
        {<Chart data={LineData} charInfo={[{ "XValue": "year", 'Yvalue': 'customer', 'Ctype': 'scatter', 'Id': 'Scatter' }]} />}
      </div>
    </div>
  )
}
